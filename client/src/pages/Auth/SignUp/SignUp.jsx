  ...
  return (
    <FormBase>
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div
          className={`inputBlock ${validUname ? "validUname" : "inValidUname"}`}
        >
          <label htmlFor="username" className={`txtInputLable inputLable`}>
            Username:
          </label>
          <input
            type="text"
            ...
            className={`uNameInput txtInput`}
          />
          {validUname === false && (
            <p className="uNameWarning">
        ...
        <div
          className={`inputBlock gmailInputBlock ${
            validgmail ? "validgmail" : "inValidgmail"
          }`}
        >
          <label htmlFor="gmail" className={`gmailInputLable inputLable`}>
            Gmail:
          </label>
          <input
            type="email"
            ...
            ref={gmailRef}
            onBlur={handlegmail}
            className={`gmailInput txtInput`}
          />
          {validgmail === false && (
            <p className="gmailWarning">Please enter a valid gmail address</p>
          )}
        </div>
        ...
        <div
          className={`inputBlock ${
            pwdConfirmed ? "pwdConfirmed" : "pwdNotConfirmed"
          }`}
        >
          <label htmlFor="confirmPwd" className={`confirmPwdLable inputLable`}>
            confirm Password:
          </label>
          <input
            type="password"
            ...
            className={`confirmPwdInput txtInput`}
          />
          {pwdConfirmed === false && (
            <p className="confirmPwdWarning">Passwords do not match!</p>
          )}
        </div>
